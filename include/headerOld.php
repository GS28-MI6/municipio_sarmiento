<div class="titular">
    <a href="index.php"><img src="img/logo_municipio.png" alt="" class="logo_muni"></a>
    <div class="redes">
    ...
    <div class="toggler">
        ...
        <a href="#" class="btnMenu" aria-hidden="true" onclick="header()"><i class="icono fa fa-bars"></i></a>
    </div>
<nav class="navNoB" id="nav">
    <ul class="principal">
        <li class="button_nav">
            <div class="buttonNoB">
                <a href="index.php" class="link"><i class="fas fa-home"></i>Inicio</a>
            </div>
        </li>
        <li class="button_nav">
            ...
            <ul class="hide dropdown" id="nosotros">
                ...
                <li><a href="paginas/salud.php" class="linkDropdown"><i class="fas fa-building"></i>Municipio</a></li>
                <li><a href="paginas/salud.php" class="linkDropdown"><i class="fas fa-mug-hot"></i>Cultura</a></li>
            </ul>
        </li>
        <li class="button_nav">
            ...
            <ul class="hide dropdown" id="gestion">
                ...
                <li><a href="busqueda.php" class="linkDropdown"><i class="fas fa-search"></i>Datos de Sarmiento</a> </li>
            </ul>
        </li>
        <li class="button_nav">
            ...
            <ul class="hide dropdown" id="servicios">
                ...
                <li><a href="reclamosSarmiento/" class="linkDropdown"><i class="fas fa-hands-helping"></i>Reclamos Sarmiento</a></li>
            </ul>
        </li>
        <li class="button_nav">
            <div class="buttonNoB">
                <a href="busqueda.php"><i class="fas fa-search"></i>Datos Abiertos</a>
            </div>
        </li>
        <li class="button_nav">
            <div class="buttonNoB">
                <a href="mapas.php"  class="link"><i class="fas fa-road"></i>Mapas</a>
            </div>
        </li>
    </ul>
</nav>