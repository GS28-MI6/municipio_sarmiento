...
<body onload="grafico('pie')">
    ...
    <div class="jumbotron pt-5 pb-5">
        ...
        <div class="input-group mb-3 justify-content-center">
            <a href="../mapa.php/?mapa=<?php echo $id ?>" class="btn btn-info btn-md btn-outline-dark font-weight-bold text-uppercase m-2" style="background-color: rgb(92, 159, 214);"><i class="fas fa-undo mr-2"></i> Volver al mapa</a>
    ...
    function grafico(tipo) {
        ...
        while ($mostrar = mysqli_fetch_array($result)) {
            ...
            $(document).ready(function() {
                var dataPoints = [];
                $.getJSON("<?php echo '../mapas/' . $mostrar['categoria'] . '/' . $mostrar['titulo'] . '/' . $mostrar['datos'] ?>", function(result) {
